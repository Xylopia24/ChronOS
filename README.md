...
Infromation:
- Please edit your "Height" to 30, and your "Width" to 80 to make sure the UI displayers properly, otherwise it won't, do this in your "computercraft-server.toml"
- Make sure you have "pocket Unlimited" Installed for full functionality, I cannot confirm that the program won't break without it.
- I thank MBS (Mildly Better Shell) for their awesome improvided default Shell.
...
- Get the "STATS" Page to showcase some generic stat information such as "GPS" and other helpful information, Likely won't contain any actual "Health" readouts as that doesn't matter too much in MC as it's provided by the default Interface (Subject to Change).
    - This will use the "Environment Detector" from Advanced Peripherals.
